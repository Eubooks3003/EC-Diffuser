...
mode_to_args = {
  '16C_dlp': {
    ...
    'override_dataset_path': '/home/ellina/Desktop/data/rlbench_preprocessed_multiview_tokens/rlbench_meat_off_grill/rlbench_meat_off_grill.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/rlbench_preprocessed_multiview_tokens/rlbench_meat_off_grill/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/rlbench_preprocessed_multiview_tokens/rlbench_meat_off_grill/dlp_config.json',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_meat_off_grill_multientity/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_meat_off_grill_multientity/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
