"""
Multitask DexJoCo bimanual @84 — hand-as-ONE-token action + proprio.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/dexjoco84_bimanual_multitask_handtoken/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/dexjoco84_bimanual_multitask_handtoken/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
    },
