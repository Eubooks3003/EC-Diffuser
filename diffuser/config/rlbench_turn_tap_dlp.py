...
# RLBench 2D-DLP language-conditioned config for task: turn_tap
# Mode key matches setup.py: "{num_entity}C_{input_type}". Use --num_entity 16 --input_type dlp.
mode_to_args = {
  '16C_dlp': {
    'dataset': 'turn_tap',
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_turn_tap/rlbench_turn_tap.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_turn_tap/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_turn_tap/dlp_config.json',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_turn_tap/',
