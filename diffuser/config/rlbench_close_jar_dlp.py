...
mode_to_args = {
  '16C_dlp': {
    'dataset': 'close_jar',
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_close_jar/rlbench_close_jar.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_close_jar/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_close_jar/dlp_config.json',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_close_jar/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_close_jar/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
