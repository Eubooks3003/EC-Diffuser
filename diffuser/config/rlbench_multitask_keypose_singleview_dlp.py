"""2D multi-task keypose v2 config -- SINGLEVIEW flavor (front view only).

Reuses the 4-view multiview pkls but slices to view 0 (front) at load time.
1 view x 20 kp_enc = 20 particles; multiview=False; split_action_tokens=False.
...
mode_to_args = {
  '16C_dlp': {
    ...
    'use_views': [0],         # 0=front
    'num_source_views': 4,
    'rlbench_cams': ['front'],   # paper-eval env cams; must match use_views
    'device': 'cuda:0',
...
base = {
    'diffusion': {
        ...
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_multitask_keypose_singleview/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_multitask_keypose_singleview/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
