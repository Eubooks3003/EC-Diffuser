"""
Multitask multiview mimicgen @224 — UNIFORM action + UNIFORM proprio.
...
The 224 sibling of mimicgen_multitask_dlp.py.
"""
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen224_multitask_uniform/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen224_multitask_uniform/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
