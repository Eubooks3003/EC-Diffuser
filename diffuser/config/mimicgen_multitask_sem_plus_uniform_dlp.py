"""
Multitask multiview mimicgen — semantic action + a UNIFORM AUX branch.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen_multitask_sem_plus_uniform/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen_multitask_sem_plus_uniform/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
