"""
Multitask multiview mimicgen — semantic + single, on BOTH action and proprio.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen_multitask_sem_plus_single_dualprop/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen_multitask_sem_plus_single_dualprop/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
