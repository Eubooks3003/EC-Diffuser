...
mode_to_args = {
  '16C_dlp': {
    'dataset': 'pick_place',
    'override_dataset_path': '/lambda/nfs/tal-lpwm-neurips-2026/data/3D-DLP-mimicgen-data/preprocessed_multiview_tokens/pick_place_d0/pick_place_d0.pkl',
    'calib_h5_path': '/lambda/nfs/tal-lpwm-neurips-2026/data/3D-DLP-mimicgen-data/core/pick_place_d0.hdf5',
    'dlp_ckpt': '/lambda/nfs/tal-lpwm-neurips-2026/data/3D-DLP-mimicgen-data/preprocessed_multiview_tokens/pick_place_d0/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/lambda/nfs/tal-lpwm-neurips-2026/data/3D-DLP-mimicgen-data/preprocessed_multiview_tokens/pick_place_d0/dlp_config.json',
    ...
    'multiview': True,
    'device': 'cuda:0',
    'max_path_length': 798,   # Tmax from 2D multiview pkl
    'max_demos': 200,
    'eval_freq': 0,
    'eval_backend': 'none',
    'n_steps_per_epoch': 500,
    "mimicgen_cams": ["agentview", "frontview"],
