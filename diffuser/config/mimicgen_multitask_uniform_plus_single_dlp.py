"""
Multitask multiview mimicgen — uniform action + a single-action AUX branch.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen_multitask_uniform_plus_single/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen_multitask_uniform_plus_single/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
