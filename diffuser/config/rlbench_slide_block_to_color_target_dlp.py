...
# RLBench 2D-DLP language-conditioned config for task: slide_block_to_color_target
# Mode key matches setup.py: "{num_entity}C_{input_type}". Use --num_entity 16 --input_type dlp.
mode_to_args = {
  '16C_dlp': {
    'dataset': 'slide_block_to_color_target',
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_slide_block_to_color_target/rlbench_slide_block_to_color_target.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_slide_block_to_color_target/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_slide_block_to_color_target/dlp_config.json',
    ...
    'bg_dim': 20,             # learned_bg_feature_dim(4) x 5 views
    'use_bg_obs': True,
    'max_particles': 80,      # 5 views x topk=15 = 75, rounded to 80
    'multiview': True,
    'device': 'cuda:0',
    ...
    'lang_device': 'cpu',
    'rlbench_cams': ['front', 'overhead', 'left_shoulder', 'right_shoulder', 'wrist'],
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_slide_block_to_color_target/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_slide_block_to_color_target/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
