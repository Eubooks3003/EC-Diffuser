"""
Multitask multiview mimicgen @84 — SINGLE action token + SEMANTIC proprio.

action_token_groups=[7] emits ONE token for the whole action vector while
proprio keeps the semantic pos/rot6d/grip split. Note this is the grouped path,
NOT `split_action_tokens=False`: that flag toggles action and proprio splitting
together and so cannot express semantic proprio.
"""
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen84_multitask_singleaction/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen84_multitask_singleaction/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
