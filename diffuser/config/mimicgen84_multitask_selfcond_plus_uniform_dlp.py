"""
Multitask multiview mimicgen @84 — UNIFORM + a SELF-CONDITIONED action token.

Primary (executed) tokenization is per-dim uniform action and proprio. On top of that sits ONE extra
...
Control run: mimicgen84_multitask_uniform_dlp.py. The self-cond token is the only delta.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen84_multitask_selfcond_plus_uniform/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen84_multitask_selfcond_plus_uniform/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
