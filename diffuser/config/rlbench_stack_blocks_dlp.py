...
# RLBench 2D-DLP language-conditioned config for task: stack_blocks
# Mode key matches setup.py: "{num_entity}C_{input_type}". Use --num_entity 16 --input_type dlp.
mode_to_args = {
  '16C_dlp': {
    'dataset': 'stack_blocks',
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_stack_blocks/rlbench_stack_blocks.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_stack_blocks/dlp_ckpt.pt',
    'dlp_ctor': "models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/preprocessed_multiview_tokens/rlbench_stack_blocks/dlp_config.json',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_stack_blocks/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_stack_blocks/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
