...
mode_to_args = {
  '16C_dlp': {
    ...
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_voxel_tokens_with_keyposes/rlbench_put_item_in_drawer/put_item_in_drawer.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ellina/Desktop/data/preprocessed_voxel_tokens_with_keyposes/rlbench_put_item_in_drawer/dlp_ckpt.pt',
    'dlp_ctor': "voxel_models:DLP",
    'dlp_cfg': '/home/ellina/Desktop/data/preprocessed_voxel_tokens_with_keyposes/rlbench_put_item_in_drawer/dlp_config.json',
