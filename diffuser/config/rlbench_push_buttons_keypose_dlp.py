...
# RLBench language-conditioned config for task: push_buttons
...
mode_to_args = {
  '16C_dlp': {
    ...
    'override_dataset_path': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens_with_keyposes/rlbench_push_buttons/push_buttons.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens_with_keyposes/rlbench_push_buttons/dlp_ckpt.pt',
    'dlp_ctor': "voxel_models:DLP",
    'dlp_cfg': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens_with_keyposes/rlbench_push_buttons/dlp_config.json',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_push_buttons_keypose/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_push_buttons_keypose/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
