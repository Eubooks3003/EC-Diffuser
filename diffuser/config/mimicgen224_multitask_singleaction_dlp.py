"""
Multitask multiview mimicgen @224 — SINGLE action token + SEMANTIC proprio.
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/mimicgen224_multitask_singleaction/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/mimicgen224_multitask_singleaction/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
