"""
Multitask DexJoCo single @84 — SINGLE action token + SEMANTIC proprio.
...
base = {
    'diffusion': {
        ...
        'action_token_groups': [22],
        'proprio_token_groups': [3, 4, 4, 4, 4, 4],
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/dexjoco84_single_multitask_singleaction/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/dexjoco84_single_multitask_singleaction/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
    },
