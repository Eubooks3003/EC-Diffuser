"""
Multitask DexJoCo MERGED single+bimanual @84 — SEMANTIC action + SEMANTIC proprio.
...
base = {
    'diffusion': {
        ...
        'action_token_groups': [3, 3, 4, 4, 4, 4, 3, 3, 4, 4, 4, 4],
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/dexjoco84_merged_multitask_semantic/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/dexjoco84_merged_multitask_semantic/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
    },
