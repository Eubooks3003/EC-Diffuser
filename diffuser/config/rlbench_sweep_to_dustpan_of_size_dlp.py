...
mode_to_args = {
  '16C_dlp': {
    ...
    'override_dataset_path': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens/rlbench_sweep_to_dustpan_of_size/sweep_to_dustpan_of_size.pkl',
    'calib_h5_path': None,  # RLBench does not use a robomimic calib HDF5
    'dlp_ckpt': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens/rlbench_sweep_to_dustpan_of_size/dlp_ckpt.pt',
    'dlp_ctor': "voxel_models:DLP",
    'dlp_cfg': '/home/ubuntu/tal-lpwm-neurips-2026/data/rlbench/preprocessed_voxel_tokens/rlbench_sweep_to_dustpan_of_size/dlp_config.json',
