...
class GaussianDiffusion(nn.Module):
    ...
    def p_mean_variance(self, x, cond, t, lang=None, lang_mask=None, action_cond=None):
        x_recon = self.predict_start_from_noise(
            x, t=t, noise=self.model(x, cond, t, lang=lang, lang_mask=lang_mask))
    ...
    def p_losses(self, x_start, cond, t, action_cond=None, lang=None, lang_mask=None):
        ...
        x_noisy = apply_conditioning(x_noisy, cond, self.action_dim, action_conditions=action_cond, pin_obs=not self.keypose_mode)

        x_recon = self.model(x_noisy, cond, t, lang=lang, lang_mask=lang_mask)
